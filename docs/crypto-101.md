...
<span class="roam-page">["How to Get a Job in Crypto"](docs/how-to-get-a-job-in-crypto)</span>
...
<span class="roam-page">[Bankless](docs/bankless)</span> Job Board →  https://pallet.xyz/list/bankless/jobs
...
["NFT Canon"](https://a16z.com/2021/04/02/nfts-readings-resources/) - Go-to resource curated by <span class="roam-page">[a16z](docs/a16z)</span> about NFTs
...
> Find more <span class="roam-page">[metaverse](docs/metaverse)</span> projects and resources → <span class="roam-page">[Awesome Metaverse](docs/awesome-metaverse)</span>

### Learn about [[DAOs]]:

Report: <span class="roam-page">["DAOs - The new frontier in Coordination"](docs/daos-the-new-frontier-in-coordination)</span>
...
**Educational Course:** <span class="roam-page">[Forefront Learn](docs/forefront-learn)</span> -- ongoing education on social tokens, DAOs, web3, and beyond.
...
<span class="roam-page">["Own the internet: A bull case for Ethereum"](docs/own-the-internet-a-bull-case-for-ethereum)</span>
...
**🏡HOME🏡** → <span class="roam-page">[🪴 CRYPTO GARDEN HOMEPAGE](docs/crypto-garden-homepage)</span>
